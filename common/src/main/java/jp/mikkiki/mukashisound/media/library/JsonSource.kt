package jp.mikkiki.mukashisound.media.library

import android.net.Uri
import android.support.v4.media.MediaBrowserCompat.MediaItem
import android.support.v4.media.MediaDescriptionCompat.STATUS_NOT_DOWNLOADED
import android.support.v4.media.MediaMetadataCompat
import jp.mikkiki.mukashisound.media.extensions.album
import jp.mikkiki.mukashisound.media.extensions.albumArtUri
import jp.mikkiki.mukashisound.media.extensions.artist
import jp.mikkiki.mukashisound.media.extensions.displayDescription
import jp.mikkiki.mukashisound.media.extensions.displayIconUri
import jp.mikkiki.mukashisound.media.extensions.displaySubtitle
import jp.mikkiki.mukashisound.media.extensions.displayTitle
import jp.mikkiki.mukashisound.media.extensions.downloadStatus
import jp.mikkiki.mukashisound.media.extensions.duration
import jp.mikkiki.mukashisound.media.extensions.flag
import jp.mikkiki.mukashisound.media.extensions.genre
import jp.mikkiki.mukashisound.media.extensions.id
import jp.mikkiki.mukashisound.media.extensions.mediaUri
import jp.mikkiki.mukashisound.media.extensions.title
import jp.mikkiki.mukashisound.media.extensions.trackCount
import jp.mikkiki.mukashisound.media.extensions.trackNumber
...
internal class JsonSource(private val source: Uri) : AbstractMusicSource() {
    ...
    companion object {
        const val ORIGINAL_ARTWORK_URI_KEY = "jp.mikkiki.mukashisound.JSON_ARTWORK_URI"
    }
